...
namespace sark{
	...
	bool Ray::IsIntersectedWith(IShape* shape){
		switch (shape->GetType()){
		case IShape::RAY:
			return false;
		case IShape::SPHERE:
			return IsIntersected(this, dynamic_cast<Sphere*>(shape));
		case IShape::AABOX:
			return IsIntersected(this, dynamic_cast<AxisAlignedBox*>(shape));
		case IShape::OBOX:
			return IsIntersected(this, dynamic_cast<OrientedBox*>(shape));
		case IShape::POLYHEDRON:
			return IsIntersected(this, dynamic_cast<Polyhedron*>(shape));
		default:
			if (extChecker != NULL)
	...
	bool Sphere::IsIntersectedWith(IShape* shape){
		switch (shape->GetType()){
		case IShape::RAY:
			return IsIntersected(dynamic_cast<Ray*>(shape), this);
		case IShape::SPHERE:
			return IsIntersected(this, dynamic_cast<Sphere*>(shape));
		case IShape::AABOX:
			return IsIntersected(this, dynamic_cast<AxisAlignedBox*>(shape));
	...
	bool AxisAlignedBox::IsIntersectedWith(IShape* shape){
		switch (shape->GetType()){
		case IShape::RAY:
			return IsIntersected(dynamic_cast<Ray*>(shape), this);
		case IShape::SPHERE:
			return IsIntersected(dynamic_cast<Sphere*>(shape), this);
		case IShape::AABOX:
			return IsIntersected(this, dynamic_cast<AxisAlignedBox*>(shape));
		case IShape::OBOX:
			return IsIntersected(this, dynamic_cast<OrientedBox*>(shape));
	...
	bool OrientedBox::IsIntersectedWith(IShape* shape){
		switch (shape->GetType()){
		case IShape::RAY:
			return IsIntersected(dynamic_cast<Ray*>(shape), this);
		case IShape::SPHERE:
			return IsIntersected(dynamic_cast<Sphere*>(shape), this);
		case IShape::AABOX:
			return IsIntersected(dynamic_cast<AxisAlignedBox*>(shape), this);
		case IShape::OBOX:
			return IsIntersected(this, dynamic_cast<OrientedBox*>(shape));
		case IShape::POLYHEDRON:
			return IsIntersected(this, dynamic_cast<Polyhedron*>(shape));
	...
	bool Polyhedron::IsIntersectedWith(IShape* shape){
		switch (shape->GetType()){
		case IShape::RAY:
			return IsIntersected(dynamic_cast<Ray*>(shape), this);
		case IShape::SPHERE:
		...
		case IShape::AABOX:
			return IsIntersected(dynamic_cast<AxisAlignedBox*>(shape), this);
		case IShape::OBOX:
			return IsIntersected(dynamic_cast<OrientedBox*>(shape), this);
		case IShape::POLYHEDRON:
			return IsIntersected(this, dynamic_cast<Polyhedron*>(shape));
		default:
			if (extChecker != NULL)
	...
	bool IsIntersected(Ray* ray, AxisAlignedBox* aabox){ return false; }
	
	// ray - oriented box intersection
	bool IsIntersected(Ray* ray, OrientedBox* obox){ return false; }
	
	// ray - polyhedron intersection
	bool IsIntersected(Ray* ray, Polyhedron* poly){ return false; }
	...
	bool IsIntersected(Sphere* sphere, AxisAlignedBox* aabox){ return false; }
	
	// sphere - oriented box intersection
	bool IsIntersected(Sphere* sphere, OrientedBox* obox){ return false; }
	
	// sphere - polyhedron intersection
	bool IsIntersected(Sphere* sphere, Polyhedron* poly){ return false; }

	// axis aligned box - axis aligned box intersection
	bool IsIntersected(AxisAlignedBox* aabox1, AxisAlignedBox* aabox2){ return false; }
	
	// axis aligned box - oriented box intersection
	bool IsIntersected(AxisAlignedBox* aabox, OrientedBox* obox){ return false; }
	
	// axis aligned box - polyhedron intersection
	bool IsIntersected(AxisAlignedBox* aabox, Polyhedron* poly){ return false; }

	// oriented box - oriented box intersection
	bool IsIntersected(OrientedBox* obox1, OrientedBox* obox2){ return false; }
	
	// oriented box - polyhedron intersection
	bool IsIntersected(OrientedBox* obox, Polyhedron* poly){ return false; }

	// polyhedron - polyhedron intersection
	bool IsIntersected(Polyhedron* poly1, Polyhedron* poly2){ return false; }
